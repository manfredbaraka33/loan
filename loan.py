...
applicant_income = st.number_input('Applicant Income', help="Enter your monthly income in USD")
coapplicant_income = st.number_input('Coapplicant Income', help="Enter co-applicant's monthly income in USD")
loan_amount = st.number_input('Loan Amount', help="Enter the requested loan amount in USD")
loan_amount_term = st.number_input('Loan Amount Term', help="Enter the term of the loan in months",min_value=0)
